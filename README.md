...
- **🗣🔡 Language:** <br>I speak Indonesian `id_ID` and English `en_EN`, and previously learning Mandarin `zh_CN`, where more & more Mainland China who can't speak English work in ma Country, wilddd 🙈
...
- **🍔🍟 Foods API:** <br>An API that Store lists of Foods database.  If the project is on-going, we add more API food lists, with 3D lowpoly foods.
